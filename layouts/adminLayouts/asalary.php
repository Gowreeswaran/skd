<?php
    ...
    if(isset($_POST['deleteSalaryInformation'])){
        deleteSalaryInformation($conn,$_POST['deleteSalaryInformation']);
    }
    if(isset($_POST['btnCustomersDataEdit'])){
        editSalaryDetails($conn,$_POST['txtEditSalaryDetailsId'],$_POST['txtPerDayBasic'],$_POST['txtAttandance'],$_POST['txtTotalBasicSalary'],$_POST['txtComission'],$_POST['txtComissionPercentage'],$_POST['txtTotalComission'],$_POST['txtIncentive'],$_POST['txtTotalGrossSalary'],$_POST['txtSortStore'],$_POST['txtTotalAdvance'],$_POST['txtTotalDischargers'],$_POST['txtNetSalary'],$_POST['txtSalaryMonth'],$_POST['txtSalaryYear']);
    }
...
<div class="row">
        ...
        <?php
            if(isset($_GET['esde'])){
                $fetchedSalaryDetails = fetchEmployeeSalaryDetails($conn,$_GET['esde']);
        ?>
        <div class="col-12">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-header">
                    Edit Salary Details of <?=ucwords($dataUser['staffsName'], " ") . " (" . strtoupper($_GET['vsid']) . ") ";?>
                </div>
                <div class="card-body">
                    <form action="" method="POST">
                        <input type="hidden" name="txtEditSalaryDetailsId" id="txtEditSalaryDetailsId" value="<?=$_GET['esde'];?>"/>
                                ...
                                <tr class="table-secondary">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                ...
                                                <option value="01" <?=($fetchedSalaryDetails['salaryMonth']==1)?'selected':'';?>>January</option>
                                                <option value="02" <?=($fetchedSalaryDetails['salaryMonth']==2)?'selected':'';?>>February</option>
                                                <option value="03" <?=($fetchedSalaryDetails['salaryMonth']==3)?'selected':'';?>>March</option>
                                                <option value="04" <?=($fetchedSalaryDetails['salaryMonth']==4)?'selected':'';?>>April</option>
                                                <option value="05" <?=($fetchedSalaryDetails['salaryMonth']==5)?'selected':'';?>>May</option>
                                                <option value="06" <?=($fetchedSalaryDetails['salaryMonth']==6)?'selected':'';?>>June</option>
                                                <option value="07" <?=($fetchedSalaryDetails['salaryMonth']==7)?'selected':'';?>>July</option>
                                                <option value="08" <?=($fetchedSalaryDetails['salaryMonth']==8)?'selected':'';?>>August</option>
                                                <option value="09" <?=($fetchedSalaryDetails['salaryMonth']==9)?'selected':'';?>>September</option>
                                                <option value="10" <?=($fetchedSalaryDetails['salaryMonth']==10)?'selected':'';?>>October</option>
                                                <option value="11" <?=($fetchedSalaryDetails['salaryMonth']==11)?'selected':'';?>>November</option>
                                                <option value="12" <?=($fetchedSalaryDetails['salaryMonth']==12)?'selected':'';?>>December</option>
                                                </select>
                                            </div>
                                        </td>
                                        <td>Salary Year</td>
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <select class="form-control" id="txtSalaryYear" name="txtSalaryYear">
                                                    ...
                                                    <option value="2020" <?=($fetchedSalaryDetails['salaryYear']=='2020')?'selected':'';?>>2020</option>
                                                    <option value="2021" <?=($fetchedSalaryDetails['salaryYear']=='2021')?'selected':'';?>>2021</option>
                                                    <option value="2022" <?=($fetchedSalaryDetails['salaryYear']=='2022')?'selected':'';?>>2022</option>
                                                    <option value="2023" <?=($fetchedSalaryDetails['salaryYear']=='2023')?'selected':'';?>>2023</option>
                                                    <option value="2024" <?=($fetchedSalaryDetails['salaryYear']=='2024')?'selected':'';?>>2024</option>
                                                    <option value="2025" <?=($fetchedSalaryDetails['salaryYear']=='2025')?'selected':'';?>>2025</option>
                                                    <option value="2026" <?=($fetchedSalaryDetails['salaryYear']=='2026')?'selected':'';?>>2026</option>
                                                    <option value="2027" <?=($fetchedSalaryDetails['salaryYear']=='2027')?'selected':'';?>>2027</option>
                                                    <option value="2028" <?=($fetchedSalaryDetails['salaryYear']=='2028')?'selected':'';?>>2028</option>
                                                    <option value="2029" <?=($fetchedSalaryDetails['salaryYear']=='2029')?'selected':'';?>>2029</option>
                                                    <option value="2030" <?=($fetchedSalaryDetails['salaryYear']=='2030')?'selected':'';?>>2030</option>
                                                    <option value="2031" <?=($fetchedSalaryDetails['salaryYear']=='2031')?'selected':'';?>>2031</option>
                                                </select>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="table-success">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;" id="txtPerDayBasic" name="txtPerDayBasic" placeholder="Enter Per Day Basic" value="<?=$fetchedSalaryDetails['basicPerDay'];?>">
                                            </div>
                                        </td>
                                        <td>
                                            <label class="sr-only" for="txtAttandance">Attandance</label>
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;" id="txtAttandance" name="txtAttandance" placeholder="Enter Attandance" value="<?=$fetchedSalaryDetails['attendance'];?>">
                                            </div>
                                        </td>
                                        <td>
                                            <label class="sr-only" for="txtTotalBasicSalary">Total Basic Salary</label>
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:green;" id="txtTotalBasicSalary" name="txtTotalBasicSalary" placeholder="Total Basic Salary" value="<?=$fetchedSalaryDetails['basicTotal'];?>" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="table-success">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;" id="txtComission" name="txtComission" placeholder="Enter Comission" value="<?=$fetchedSalaryDetails['comissionAmount'];?>">
                                            </div>
                                        </td>
                                        <td>
                                            <label class="sr-only" for="txtComissionPercentage">Comission Percentage</label>
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;" id="txtComissionPercentage" name="txtComissionPercentage" placeholder="Enter Comission Percentage" value="<?=$fetchedSalaryDetails['commissionPercentage'];?>">
                                            </div>
                                        </td>
                                        <td>
                                            <label class="sr-only" for="txtTotalComission">Total Comission</label>
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:green;" id="txtTotalComission" name="txtTotalComission" placeholder="Total Comission" value="<?=$fetchedSalaryDetails['totalComission'];?>" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="table-success">
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:green;" id="txtIncentive" name="txtIncentive" placeholder="Enter Incentive" value="<?=$fetchedSalaryDetails['incentive'];?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-success">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:green;" id="txtTotalGrossSalary" name="txtTotalGrossSalary" placeholder="Total Gross Salary" value="<?=$fetchedSalaryDetails['grossSalaray'];?>" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="table-danger">
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:red;" id="txtSortStore" name="txtSortStore" placeholder="Total Sort Store" value="<?=$fetchedSalaryDetails['sortStore'];?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-danger">
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:red;" id="txtTotalAdvance" name="txtTotalAdvance" placeholder="Total Advance" value="<?=$fetchedSalaryDetails['advance'];?>">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-danger">
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:red;" id="txtTotalDischargers" name="txtTotalDischargers" placeholder="Total Dischargers" value="<?=$fetchedSalaryDetails['totalDischarges'];?>" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-primary">
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="input-group mb-2 col-12">
                                                <input type="text" class="form-control" style="text-align: right;color:blue;" id="txtNetSalary" name="txtNetSalary" placeholder="Net Salary" value="<?=$fetchedSalaryDetails['netSalary'];?>" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="table-dark">
