...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item active" href="admin.php?crdsd"><i class="fas fa-caret-right"></i>Credit Sales</a>
            <a class="dropdown-item" href="admin.php?chqsd">Cheque Sales</a>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="card-body">
                    ...
                    ?>
                        ...
                        <div class="row">
                            <form action="admin.php?crdsd" method="POST" class="form-inline">
...
<div class="row">
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card border-left-secondary shadow h-100 py-2">
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="admin.php?crdsd&findView" method="POST" class="form-inline">
