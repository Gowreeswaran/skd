...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item active" href="admin.php?acbcr"><i class="fas fa-caret-right"></i>A/C Bill Collections</a>
        </div>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="d-flex justify-content-center">
                            <form action="admin.php?acbcr" method="POST" class="form-inline">
