...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item active" href="admin.php?acbillnrepcol"><i class="fas fa-caret-right"></i>A/C B in R.H To Colt</a>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="d-flex justify-content-center">
                            <form action="admin.php?acbillnrepcol" method="POST" class="form-inline">
                    ...
                    <p></p><p></p>
                        ...
                        <div class="row">
                            <div class="input-group col-4">
                                <div class="d-flex justify-content-center">
                                    <form action="admin.php?acbillnrepcol" method="POST">
