...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item active" href="admin.php"><i class="fas fa-caret-right"></i>Main Board</a>
            <a class="dropdown-item" href="admin.php?bb">Bill Board</a>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?=viewProfitForDashboard($conn,date("Y"),date("m")) . " Rs"?></div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-cash-register fa-2x text-gray-500"></i>
                    </div>
                </div>
            </div>
        </div>
