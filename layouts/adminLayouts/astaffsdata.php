...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item" href="admin.php?cd">Customers</a>
            <a class="dropdown-item active" href="admin.php?sd"><i class="fas fa-caret-right"></i>Staffs</a>
...
<?php
    if(isset($_GET['vsid'])){
        $stfData = fetchStaffDetails($conn,$_GET['vsid']);
        if($stfData['staffsType'] == "Rep"){
?>
    <div class="row">
        <div class="col-12">
            <div class="row">
                <?php
                    $thisMonthData = viewBasicSaleReportForSIDForThisMonth($conn,$_GET['vsid']);
                ?>
                <div class="col-3">
                    <p>This Month Details</p>
                </div>
                <div class="col-1">
                    <h6>Cash</h6>
                </div>
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($thisMonthData['totalCashAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Cheque</h6>
                </div>
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($thisMonthData['totalChequeAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Credit</h6>
                </div>
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($thisMonthData['totalACAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Total</h6>
                </div>
                <div class="col-2">
                    <p style="text-align: right;"><strong><?=number_format($thisMonthData['totalAllAmount'],2);?> Rs</strong></p>
                </div>
            </div>
            <p></p><p></p>
            <div class="row">
                <?php
                    $allData = viewBasicSaleReportForSIDForAllTime($conn,$_GET['vsid']);
                ?>
                <div class="col-3">
                    <p>Whole Time</p>
                </div>
                ...
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($allData['totalCashAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Cheque</h6>
                </div>
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($allData['totalChequeAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Credit</h6>
                </div>
                <div class="col-1">
                    <p style="text-align: right;"><?=number_format($allData['totalACAmount'],2);?> Rs</p>
                </div>
                <div class="col-1">
                    <h6>Total</h6>
                </div>
                <div class="col-2">
                    <p style="text-align: right;"><strong><?=number_format($allData['totalAllAmount'],2);?> Rs</strong></p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    viewBasicSaleReportForSID($conn,$_GET['vsid']);
                                ?>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-danger" role="alert">
                <center>
                    <strong>Sorry!</strong> No Data to Show.
                </center>
            </div>
        </div>
    </div>
        ...
        ?>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card border-left-dark shadow h-100 py-2">
                    ...
                    <div class="card-body">
                        <form action="admin.php?sd" method="POST" class="form-inline" enctype="multipart/form-data">
