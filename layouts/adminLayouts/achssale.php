...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item" href="admin.php?chqsd">Cash Sales</a>
            <a class="dropdown-item active" href="admin.php?cahsd"><i class="fas fa-caret-right"></i>Cash Sales</a>
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <form action="admin.php?cahsd" method="POST" class="form-inline">
