...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <a class="dropdown-item active" href="user.php?cd"><i class="fas fa-caret-right"></i>Customers</a>
    ...
    ?>
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <div class="card-body">
                    <form action="user.php?cd" method="POST" class="form-inline">
                        ...
                        <div class="row">
                            <div class="input-group col-12">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="user.php?cd" class="btn btn-danger mb-2 mr-sm-4">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                                    showCustomersDetailsForUser($conn);
                                ?>
                            </tbody>
                        </table>
                    </div>
