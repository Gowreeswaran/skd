...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item active" href="user.php?chqdep"><i class="fas fa-caret-right"></i>Cheque Deposite</a>
            <a class="dropdown-item" href="user.php?voucher">Voucher</a>
        </div>
    </div>
</div>
                    ...
                    ?>
                        <div class="row">
                            <div class="d-flex justify-content-center">
                                <form action="user.php?chqdep" method="POST" class="form-inline">
